...
export const HARD_RULES = {
  ...
  SUMMARY: '\n\nReturn ONLY a JSON object with the complete "summary" key containing the text of the final summary (ALWAYS include the previous summary in that): { "summary": "..." }',
  PLOT_ESSENTIALS: '\n\nReturn ONLY a JSON object with the complete "plotEssentials" key containing the text of the plot essentials: { "plotEssentials": "The plot essentials in markdown text" }',
